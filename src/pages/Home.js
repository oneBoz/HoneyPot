...
import ViewPageButton from "../Components/Home/ViewPageButton";
    ...
    return (
        <Box>
            ...
            <Typography
                level="h1"
            >
                HoneyPot Financial Planning
            </Typography>
            <Stack direction="row" spacing={2}>
                <ViewPageButton link={"/News"} name={"News"}/>
                <ViewPageButton link={"/Expenses"} name={"Expenses"} />
            </Stack>
